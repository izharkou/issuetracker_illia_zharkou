...
<html>
	<head>
		...
		<title>
			<spring:message code="title.statuses"></spring:message>
		</title>
				...
				<div class="results-table">
					<table>
						<thead>
							<tr>
								<td>
									<spring:message code="statuses.table.name"></spring:message>
								</td>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${statuses}" var="status">
								<tr>
									<td>
										<a href="<c:url value="/status/edit/${status.id}"></c:url>">${status.name}</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
