...
<html>
	<head>
		...
		<script type="text/javascript" src="<c:url value="/javascripts/pages/user/editId.js"></c:url>"></script>
	</head>
	<body>
				...
				<c:choose>
					<c:when test="${empty user}">
						<div class="message error">
							<spring:message code="usersEdit.err404" />
						</div>
					</c:when>
					<c:otherwise>
						<div class="message bottom successful hidden">
							<spring:message code="usersEdit.message.successful"></spring:message>
						</div>
						<div class="message bottom error hidden">
							<spring:message code="usersEdit.message.error"></spring:message>
						</div>
