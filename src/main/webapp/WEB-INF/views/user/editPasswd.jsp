...
<html>
	<head>
		...
		<title>
			<spring:message code="title.passwdEdit"></spring:message>
		</title>
		...
		<script type="text/javascript" src="<c:url value="/javascripts/pages/user/editPasswd.js"></c:url>"></script>
	</head>
	<body>
		...
		<div id="content">
			<div class="container">
				<div class="message bottom successful hidden">
					<spring:message code="passwdEdit.message.successful"></spring:message>
				</div>
				<div class="message bottom error hidden">
					<spring:message code="passwdEdit.message.error"></spring:message>
				</div>
