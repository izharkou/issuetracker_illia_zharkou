...
<html>
	<head>
		...
		<title>
			<spring:message code="title.resolutionAdd"></spring:message>
		</title>
		...
		<script type="text/javascript" src="<c:url value="/javascripts/pages/resolution/add.js"></c:url>"></script>
	</head>
	<body>
		...
		<div id="content">
			<div class="container">
				<div class="message bottom successful hidden">
					<spring:message code="resolutionAdd.message.successful"></spring:message>
				</div>
				<div class="message bottom error hidden">
					<spring:message code="resolutionAdd.message.error"></spring:message>
				</div>
				<div class="edit-form" id="resolutionEdit">
					...
					<div class="submit">
						<span class="button">
							<spring:message code="resolutionAdd.submit"></spring:message>
						</span>
