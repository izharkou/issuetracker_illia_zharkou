...
<html>
	<head>
		...
		<script type="text/javascript" src="<c:url value="/javascripts/pages/issue/status/assigned.js"></c:url>"></script>
				...
				<div class="edit-form" id="issueEdit">
					...
					<select id="status" name="status" autocomplete="off">
						<c:forEach items="${statuses}" var="status">
							<c:if test="${status.id eq STATUS_IN_PROGRESS or status.id eq STATUS_ASSIGNED}">
