...
<html>
	<head>
		...
		<title>
			<spring:message code="title.priorities"></spring:message>
		</title>
				...
				<div class="results-table">
					<table>
						<thead>
							<tr>
								<td>
									<spring:message code="priorities.table.name"></spring:message>
								</td>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${priorities}" var="priority">
								<tr>
									<td>
										<a href="<c:url value="/priority/edit/${priority.id}"></c:url>">${priority.name}</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
